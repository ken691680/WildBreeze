...
{{--                <tr>--}}
{{--                <td align="right" style="background:url({{{ asset( 'images/ad-13.png ') }}}) repeat-y right">&nbsp;</td>--}}
{{--                <td width="200" bgcolor="#cabda1"><a href="#" target="_blank"><img src="{{{ asset( 'images/ad_pic01.jpg ') }}}" alt="" width="200" height="135" border="0" /></a></td>--}}
{{--                <td align="left" style="background:url({{{ asset( 'images/ad-15.png ') }}}) repeat-y left">&nbsp;</td>--}}
{{--                </tr>--}}
{{--                <tr>--}}
{{--                <td align="right" valign="top"><img src="{{{ asset( 'images/ad-16.png ') }}}" alt="" width="10" height="9" /></td>--}}
...
{{--                </tr>--}}
            ...
            <td align="right" valign="top">
                <table width="660" border="0" align="right" cellpadding="0" cellspacing="0">
                    ...
                    <tr valign="bottom">
                        <td height="30" colspan="3" align="right" style="background:url({{{ asset( 'images/title.png ') }}}) no-repeat left bottom">&nbsp;
                        </td>
                    </tr>
                    <tr>
                        <td width="9" rowspan="2" align="right" style="background:url({{{ asset( 'images/line-04.png ') }}}) repeat-y right">&nbsp;
                        </td>
                        <td align="center" valign="top" bgcolor="#CDBFA2">
                            <table width="640" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td height="10" align="center" valign="middle" bgcolor="#CDBFA2">
                                        <img src="{{{ asset( 'images/li.png ') }}}" alt="" width="1" height="1" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" valign="middle" bgcolor="#F1ECE6">
                                        <table width="600" border="0" align="center" cellpadding="10" cellspacing="0">
                                            <tr valign="middle">
                                                <td align="center" style="border-bottom:#97866d 1px solid">
                                                    <table width="150" border="0" align="center" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td width="150" height="150" align="center" valign="middle" bgcolor="#C9BC9C">
                                                                <a href="#">
                                                                    <img src="{{{ asset( 'images/item_pic01.jpg ') }}}" alt="" width="140" height="140" border="0" align="absmiddle" />
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr valign="middle">
                                                                        <td align="left">
                                                                            ...
                                                                            <a href="#" class="top_txt5a4f3f_a">詳細說明</a>
                                                                        </td>
                                                                        <td align="right">
...
{{--                                    </tr>--}}
                        ...
                        <td width="11" rowspan="2" align="left" style="background:url({{{ asset( 'images/line-05.png ') }}}) left repeat-y">&nbsp;
                        </td>
                    </tr>
            <tr valign="top">
...
{{--            <tr valign="top">--}}
{{--            <td align="right"><img src="{{{ asset( 'images/line_2.png ') }}}" alt="" width="9" height="35" align="right" /></td>--}}
{{--            <td align="center" valign="middle" style="background:url({{{ asset( 'images/line_2-02.png ') }}}) repeat-x top">--}}
{{--                <table border="0" cellspacing="0" cellpadding="0">--}}
{{--            <tr>--}}
{{--            <td height="5" colspan="3" align="right"><img src="{{{ asset( 'images/li.png ') }}}" alt="" width="1" height="1" /></td>--}}
{{--            </tr>--}}
{{--            <tr>--}}
{{--            <td align="right"><a href="#"><img src="{{{ asset( 'images/btn_prev.png ') }}}" alt="" width="17" height="15" hspace="10" border="0" /></a></td>--}}
{{--            <td>--}}
{{--                <table border="0" cellpadding="0" cellspacing="0">--}}
{{--            <tr>--}}
{{--            <td width="30" height="20" align="center" valign="middle" class="pages_txt4c4c4c">1</td>--}}
{{--            <td width="30" height="20" align="center" valign="middle"><div class="bg_pages" style="height:20px; width:30px; background:url({{{ asset( 'images/btn_bg01.png ') }}}) no-repeat center"><a href="#" class="pages_4c4c4c_a">2</a></div></td>--}}
{{--            <td width="30" height="20" align="center" valign="middle"><div class="bg_pages" style="height:20px; width:30px; background:url({{{ asset( 'images/btn_bg01.png ') }}}) no-repeat center"><a href="#" class="pages_4c4c4c_a">3</a></div></td>--}}
{{--            <td width="30" height="20" align="center" valign="middle"><div class="bg_pages" style="height:20px; width:30px; background:url({{{ asset( 'images/btn_bg01.png ') }}}) no-repeat center"><a href="#" class="pages_4c4c4c_a">4</a></div></td>--}}
{{--            <td width="30" height="20" align="center" valign="middle"><div class="bg_pages" style="height:20px; width:30px; background:url({{{ asset( 'images/btn_bg01.png ') }}}) no-repeat center"><a href="#" class="pages_4c4c4c_a">5</a></div></td>--}}
{{--            </tr>--}}
{{--            </table></td>--}}
{{--            <td align="left"><a href="#"><img src="{{{ asset( 'images/btn_next.png ') }}}" alt="" width="18" height="15" hspace="10" border="0" /></a></td>--}}
{{--            </tr>--}}
{{--            </table></td>--}}
{{--            <td align="left"><img src="{{{ asset( 'images/line_2-03.png ') }}}" alt="" width="11" height="35" /></td>--}}
{{--            </tr>--}}
                            <tr valign="top">
