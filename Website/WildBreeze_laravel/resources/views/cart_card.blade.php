...
<tr valign="bottom">
<td width="9" align="right"><img src="{{{ asset( 'images/line-02.png') }}}" alt="" width="9" height="40" /></td>
<td width="640" align="left" valign="middle" class="titleB" style="background:url({{{ asset( 'images/line.png') }}}) bottom repeat-x"><img src="{{{ asset( 'images/titlebar.png') }}}" alt="" width="10" height="15" align="absmiddle" />購物車</td>
<td width="11" align="left"><img src="{{{ asset( 'images/line-03.png') }}}" alt="" width="11" height="40" /></td>
</tr>
<tr>
<td rowspan="3" align="right" style="background:url({{{ asset( 'images/line-04.png') }}}) repeat-y right">&nbsp;</td>
...
<td height="200" valign="top" bgcolor="#FFFFFF" style="background:url({{{ asset( 'images/log_bg_05.png') }}}) repeat-x"><table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td height="30" align="left" valign="top"><img src="{{{ asset( 'images/title-09.png') }}}" alt="" width="149" height="21" /></td>
</tr>
<tr>
...
<td rowspan="3" align="left" style="background:url({{{ asset( 'images/line-05.png') }}}) left repeat-y">&nbsp;</td>
</tr>
<tr>
<td align="left" valign="top" bgcolor="#CDBFA2" class="txt13_313131"><table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr valign="bottom">
...
<tr>
<td height="30" align="left" valign="top" class="top_txt5a4f3f" style="border-bottom:#97866d 1px solid"><img src="{{{ asset( 'images/title_cart01.png') }}}" alt="" width="110" height="22" /></td>
</tr>
<tr>
...
<td height="30" align="center" class="btn_bg"><a href="cart_03_2.html"><img src="{{{ asset( 'images/pay_sent.jpg') }}}" alt="" width="100" height="30" border="0" /></a></td>
