...
//define("PsyPath", "/var/www/html/wildbreeze/");   //網站磁碟實際路徑
define("PsyPath", "D:/Project/Tommy/WildBreeze/Website/Website_05/");   //網站磁碟實際路徑
...
//$sRootR="/var/www/html/wildbreeze/";              //實際路徑
$sRootR="D:/Project/Tommy/WildBreeze/Website/Website_05/";              //實際路徑

$sRootV="WildBreeze_05/";                                               //網站路徑
//$sRootV="wildbreeze/";                                               //網站路徑
...
function GetConn() {
	$aDb=null;
	if (GetDeploy()) {
		$aDb=CreateDbMySQL("localhost", "wildbreeze", "root", "23216389");
	} else {
