...
// 接收參數宣告
// ===========================================================================
$ci02_value=$_GET["ci02"];
$FrontID=$_GET["FrontID"];
$Level=$_GET["Level"];

$ci02=uniDecode($ci02_value,'utf-8');
...
if ($ci02!="") {
	$aParme=Array($ci02);
	$sSQL=SQLQuryI($_SESSION["sSQLFile"], "qury09", $aParme);
	$rRs=GetRs($sSQL);
	//echo "obj.options[obj.options.length] = new Option('請選擇','');\n";
	$sSQLCountry="select * from citys where ci02='".$ci02."' limit 1";
	$iLoopForCountry=0;
	...
	while ($row = mysql_fetch_array($rRs, MYSQL_ASSOC)) {
		...
		echo "document.frmUser.me08.value='".Trim($row["ci03"])."';\n";
	}
