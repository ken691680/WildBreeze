...
$_SESSION["sSQLFile"]="REP/REP0401.sql";  //SQL檔路徑
...
Case 'Select':
	...
	//父宣告
	$_SESSION["TitleTdName_REP0401"]=Array();
	$_SESSION["SQL_REP0401"]="";
	$_SESSION["Field_REP0401"]=Array();

	$_SESSION["SQL02_REP0401"]="";
	...
	if (Trim($ShowType)=="mon") {
		...
		for ($x=0; $x<$iDiff; $x++) {
			//上方Title
			$_SESSION["TitleTdName_REP0401"]=UnidimensionalArrayAppend($_SESSION["TitleTdName_REP0401"], Replace(Left(DateAdd("m", $x, $YearStart_01."/".$MonthStart_01."/01"), 7), "/", "-"));
			//SQL Script
			$_SESSION["SQL_REP0401"]=$_SESSION["SQL_REP0401"]."(select count(*) from member where left(jointime, 7)='".Replace(Left(DateAdd("m", $x, $YearStart_01."/".$MonthStart_01."/01"), 7), "/", "-")."' ) as '".Replace(Left(DateAdd("m", $x, $YearStart_01."/".$MonthStart_01."/01"), 7), "/", "-")."', ";
			//Field
			$_SESSION["Field_REP0401"]=UnidimensionalArrayAppend($_SESSION["Field_REP0401"], Replace(Left(DateAdd("m", $x, $YearStart_01."/".$MonthStart_01."/01"), 7), "/", "-"));
			//------------ new ------------
			$_SESSION["SQL02_REP0401"]=$_SESSION["SQL02_REP0401"]."(select count(*) from memberloginview where left(lasttime, 7)='".Replace(Left(DateAdd("m", $x, $YearStart_01."/".$MonthStart_01."/01"), 7), "/", "-")."' ) as '".Replace(Left(DateAdd("m", $x, $YearStart_01."/".$MonthStart_01."/01"), 7), "/", "-")."', ";

		}
		$_SESSION["SQL_REP0401"]="select ".$_SESSION["SQL_REP0401"]." '會員數' as LeftTitleName ";
		$_SESSION["SQL02_REP0401"]="select ".$_SESSION["SQL02_REP0401"]." '會員登入數' as LeftTitleName ";
		...
		for ($x=0; $x<$iDiff; $x++) {
			...
			if ($sSeasonMonthStartNow==1) {
				$_SESSION["TitleTdName_REP0401"]=UnidimensionalArrayAppend($_SESSION["TitleTdName_REP0401"], $sLoopYear."-第一季");
				$sSeasonMonthStartNow=2;
				//SQL Script
				$_SESSION["SQL_REP0401"]=$_SESSION["SQL_REP0401"]."(select count(*) from member where left(jointime, 4) in ('".$sLoopYear."-01', '".$sLoopYear."-02', '".$sLoopYear."-03')) as '".$sLoopYear."01', ";
				//Field
				$_SESSION["Field_REP0401"]=UnidimensionalArrayAppend($_SESSION["Field_REP0401"], $sLoopYear."01");
				//------------ new ------------
				$_SESSION["SQL02_REP0401"]=$_SESSION["SQL02_REP0401"]."(select count(*) from memberloginview where left(lasttime, 4) in ('".$sLoopYear."-01', '".$sLoopYear."-02', '".$sLoopYear."-03')) as '".$sLoopYear."01', ";
			} else if ($sSeasonMonthStartNow==2) {
				$_SESSION["TitleTdName_REP0401"]=UnidimensionalArrayAppend($_SESSION["TitleTdName_REP0401"], $sLoopYear."-第二季");
				$sSeasonMonthStartNow=3;
				//SQL Script
				$_SESSION["SQL_REP0401"]=$_SESSION["SQL_REP0401"]."(select count(*) from member where left(jointime, 4) in ('".$sLoopYear."-04', '".$sLoopYear."-05', '".$sLoopYear."-06')) as '".$sLoopYear."02', ";
				//Field
				$_SESSION["Field_REP0401"]=UnidimensionalArrayAppend($_SESSION["Field_REP0401"], $sLoopYear."02");
				//------------ new ------------
				$_SESSION["SQL02_REP0401"]=$_SESSION["SQL02_REP0401"]."(select count(*) from memberloginview where left(lasttime, 4) in ('".$sLoopYear."-04', '".$sLoopYear."-05', '".$sLoopYear."-06')) as '".$sLoopYear."01', ";
			} else if ($sSeasonMonthStartNow==3) {
				$_SESSION["TitleTdName_REP0401"]=UnidimensionalArrayAppend($_SESSION["TitleTdName_REP0401"], $sLoopYear."-第三季");
				$sSeasonMonthStartNow=4;
				//SQL Script
				$_SESSION["SQL_REP0401"]=$_SESSION["SQL_REP0401"]."(select count(*) from member where left(jointime, 4) in ('".$sLoopYear."-07', '".$sLoopYear."-08', '".$sLoopYear."-09')) as '".$sLoopYear."03', ";
				//Field
				$_SESSION["Field_REP0401"]=UnidimensionalArrayAppend($_SESSION["Field_REP0401"], $sLoopYear."03");
				//------------ new ------------
				$_SESSION["SQL02_REP0401"]=$_SESSION["SQL02_REP0401"]."(select count(*) from memberloginview where left(lasttime, 4) in ('".$sLoopYear."-07', '".$sLoopYear."-08', '".$sLoopYear."-09')) as '".$sLoopYear."01', ";
			} else if ($sSeasonMonthStartNow==4) {
				$_SESSION["TitleTdName_REP0401"]=UnidimensionalArrayAppend($_SESSION["TitleTdName_REP0401"], $sLoopYear."-第四季");
				$sSeasonMonthStartNow=1;
				//SQL Script
				$_SESSION["SQL_REP0401"]=$_SESSION["SQL_REP0401"]."(select count(*) from member where left(jointime, 4) in ('".$sLoopYear."-10', '".$sLoopYear."-11', '".$sLoopYear."-12')) as '".$sLoopYear."04', ";
				//Field
				$_SESSION["Field_REP0401"]=UnidimensionalArrayAppend($_SESSION["Field_REP0401"], $sLoopYear."04");
				$sLoopYear=SafeInt($sLoopYear)+1;
				//------------ new ------------
				$_SESSION["SQL02_REP0401"]=$_SESSION["SQL02_REP0401"]."(select count(*) from memberloginview where left(lasttime, 4) in ('".$sLoopYear."-10', '".$sLoopYear."-11', '".$sLoopYear."-12')) as '".$sLoopYear."01', ";
			}
		...
		for ($x=0; $x<$iDiff; $x++) {
			//上方Title
			$_SESSION["TitleTdName_REP0401"]=UnidimensionalArrayAppend($_SESSION["TitleTdName_REP0401"], Replace(Left(DateAdd("yyyy", $x, $YearStart_03."/01/01"), 4), "/", "-"));
			//SQL Script
			$_SESSION["SQL_REP0401"]=$_SESSION["SQL_REP0401"]."(select count(*) from member where left(jointime, 4)='".Replace(Left(DateAdd("yyyy", $x, $YearStart_03."/01/01"), 4), "/", "-")."' ) as '".Replace(Left(DateAdd("yyyy", $x, $YearStart_03."/01/01"), 4), "/", "-")."', ";
			//Field
			$_SESSION["Field_REP0401"]=UnidimensionalArrayAppend($_SESSION["Field_REP0401"], Replace(Left(DateAdd("yyyy", $x, $YearStart_03."/01/01"), 4), "/", "-"));
			//------------ new ------------
			$_SESSION["SQL02_REP0401"]=$_SESSION["SQL02_REP0401"]."(select count(*) from memberloginview where left(lasttime, 4)='".Replace(Left(DateAdd("yyyy", $x, $YearStart_03."/01/01"), 4), "/", "-")."' ) as '".Replace(Left(DateAdd("yyyy", $x, $YearStart_03."/01/01"), 4), "/", "-")."', ";
		}
		$_SESSION["SQL_REP0401"]="select ".$_SESSION["SQL_REP0401"]." '會員數' as LeftTitleName ";
		$_SESSION["SQL02_REP0401"]="select ".$_SESSION["SQL02_REP0401"]." '會員登入數' as LeftTitleName ";
	}

	uLog($_SESSION["TitleTdName_REP0401"]);
...
HtmlManTopII();
//HtmlManMenuII();
HtmlManAPNameII("REP0401 - 統計分析 -＞ 會員人數");
HtmlManContentTopII();

RwForm("", "", "frmUser", "", True);
FormList($sTitleBarF, $aTitleF, $aWidthF, $aItemCodeF, $aItemParameterF, $aDescriptionF, $aButtonF, $aVisableF);
ReportDatalist($_SESSION["SQL_REP0401"], $_SESSION["TitleTdName_REP0401"], $_SESSION["Field_REP0401"], $_SESSION["SQL02_REP0401"]);
RwForm("", "", "", "", False);
...
<?php //*********************************其它模組專區********************************* ?>
<?php
function ReportDatalist($sSQLReportDatalist, $aTitleName, $aFieldName, $sSQLReportDatalist02) {
	?>
	...
	?>
	<?php
	if (Trim($sSQLReportDatalist02)!="") {
		$rRs=GetRs($sSQLReportDatalist02);
