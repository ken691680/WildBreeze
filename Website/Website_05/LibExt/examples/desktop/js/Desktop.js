                ...
                if (module) {
                    ...
                    module.createWindow();
										*/
										...
										//console.log("module.itemId == [" + module.itemId + "]");
										//console.log("Ext.isDefined(module.itemId) == [" + Ext.isDefined(module.itemId) + "]");
										//console.log("Ext.isDefined(module.id) == [" + Ext.isDefined(module.id) + "]");
										//if(Ext.isDefined(module.itemId) == false) {  
										if(Ext.isDefined(module.id) == false) {  
												//console.log("run 1");
												module.createWindow();  
										} else {  
												//console.log("run 2");
